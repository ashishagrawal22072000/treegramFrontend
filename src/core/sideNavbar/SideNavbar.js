            ...
            <div class="left">
                <div class="sidebar">
                    ...
                    <NavLink to="/" className={(navlink) => {
                        ...
                        <span class="item"><img src={Home} /></span><h3 class="link_name">Home</h3>
                    </NavLink>
                    <NavLink to="/search" className={(navlink) => {
                        console.log(navlink.isActive, "2")
                        return navlink.isActive ? "menu-item active" : "menu-item"
                    }}>
                        <span class="item"><img src={Search} /></span><h3 class="link_name">Search</h3>
                    </NavLink>
                    <NavLink to="/explore" className={(navlink) => {
                        console.log(navlink.isActive, "3")
                        return navlink.isActive ? "menu-item active" : "menu-item"
                    }}>
                        <span class="item"><img src={Explore} /></span><h3 class="link_name">Explore</h3>
                    </NavLink>
                    <NavLink to="/reel" className={(navlink) => {
                        console.log(navlink.isActive, "4")
                        return navlink.isActive ? "menu-item active" : "menu-item"
                    }}>
                        <span class="item"><img src={Reel} /></span><h3 class="link_name">Reels</h3>
                    </NavLink>
                    <NavLink to="/create" className={(navlink) => {
                        console.log(navlink.isActive, "5")
                        return navlink.isActive ? "menu-item active" : "menu-item"
                    }}>
                        <span class="item"><img src={Create} /></span><h3 class="link_name">Create</h3>
                    </NavLink>
                    <NavLink to="/notification" className={(navlink) => {
                        console.log(navlink.isActive, "6")
                        return navlink.isActive ? "menu-item active" : "menu-item"
                    }}>
                        <span class="item"><img src={Notification} /></span><h3 class="link_name">Notification</h3>
                    </NavLink>
                    <NavLink to="/analysis" className={(navlink) => {
                        console.log(navlink.isActive, "7")
                        return navlink.isActive ? "menu-item active" : "menu-item"
                    }}>
                        <span class="item"><img src={Analysis} /></span><h3 class="link_name">Analysis</h3>
                    </NavLink>
                    <NavLink to="/setting" className={(navlink) => {
                        console.log(navlink.isActive, "8")
                        return navlink.isActive ? "menu-item active" : "menu-item"
                    }}>
                        <span class="item"><img src={Setting} /></span><h3 class="link_name">Settings</h3>
                    </NavLink>
                    <NavLink class="menu-item active" to={`/profile/${auth?.username}`} className={(navlink) => {
                        console.log(navlink.isActive, "9")
                        return navlink.isActive ? "menu-item active" : "menu-item"
                    }}>
                        <span class="item">{auth && auth?.profile ? <img src={auth?.profile} /> : <img src={UserProfile} />}</span><h3 class="link_name">Profile</h3>
                    </NavLink>
                </div>
            </div>
